...
if tool_num_viz == 1:
    ...
    with st.expander("**Bấm để xem các bảng màu khả dụng**"):
        ...
        st.image('sphx_glr_colormaps_001.png')
        st.image('sphx_glr_colormaps_002.png')
        st.image('sphx_glr_colormaps_003.png')
        st.image('sphx_glr_colormaps_004.png')
        st.image('sphx_glr_colormaps_005.png')
        st.image('sphx_glr_colormaps_006.png')
        st.image('sphx_glr_colormaps_007.png')
